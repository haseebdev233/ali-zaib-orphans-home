            ...
            <div className="col-lg-10">
              <div className="card shadow-lg border-0">
                <div className="card-body p-5">
                  <h2 className="card-title text-success mb-4 text-center">Message from the Executive Director</h2>
                  ...
                  <div className="text-end">
                    <p className="mb-0 fw-bold text-success">Syed Shahid Ali Zaidi</p>
